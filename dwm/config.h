...
static const char *termcmd[]         = { "kitty", "--class", "Kitty", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask|ShiftMask,   XK_h,      setcfact,       {.f = +0.25} },
	{ MODKEY|ShiftMask|ShiftMask,   XK_l,      setcfact,       {.f = -0.25} },
	{ MODKEY|ShiftMask|ShiftMask,   XK_o,      setcfact,       {.f =  0.00} },
